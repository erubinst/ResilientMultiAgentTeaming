...
minimize max(r in Requirements) endOf(requirementTimes[r]);
...
//  		for(ao in assignments.Requirements) {
//  		  writeln(assignments.requirementTimes[ao]);
//  		};
//  		cp.solve();
//  		for(ao in assignments.Requirements) {
//  		  writeln(assignments.requirementTimes[ao].end);
//  		};
//
//}